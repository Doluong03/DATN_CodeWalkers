window.RefundController = function ($scope, $http, $window, $timeout, $document) {
    $scope.listOrders = [];
    $scope.pageNo = 0;
    $scope.sizePage = 5;
    ...
    $scope.hienThiList = function (pageNo, sizePage) {
    ...
    $scope.activeTab = 'wait_acp'; // Default to the 'all' tab
