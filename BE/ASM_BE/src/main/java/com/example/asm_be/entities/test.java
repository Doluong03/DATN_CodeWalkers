...
public class test {
    public static void main(String[] args) {
        String jdbcUrl = "jdbc:sqlserver://localhost:1433;databaseName=DATN_V3;user=sa;password=1;";
        File imageDirectory = new File("D:\\DATN_4\\DATN_CodeWalkers\\FE_Admin\\template\\images\\sp1");
